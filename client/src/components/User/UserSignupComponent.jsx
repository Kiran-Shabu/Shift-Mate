...
import logintheme from "../../images/logintheme.jpg";
...
const UserSignUP = () => {
  ...
  const { handleInputChange, isValidForm, errors, signupFormData } =
    useSignupValidation();

  const handleSubmit = async (e) => {
    console.log(signupFormData, "hhhhhh");
    ...
    try {
      ...
      console.log(signupFormData, "PPPPPPPPPPPPPPPPPPPPP");
      ...
      if (signupResponse) {
        alert("sucess");
        console.log(signupFormData, "signup page line no 43");
        navigate("/Userlogin");
      }
    } catch (error) {
      ...
      <div className=" bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
          ...
          <div className="md:block hidden w-1/2 ">
            <img className=" rounded-2xl" src={logintheme} alt="" />
          </div>
        </div>
      </div>
    </section>
